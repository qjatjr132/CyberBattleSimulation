...
def epsilon_greedy_search(
    ...
    while episode < episodes+1:
	    ...
	    # exploration episode 설정
            action_style, gym_action, action_metadata, prob = learner.exploit(wrapped_env, observation)
            if not gym_action:
            ...
            learner.on_step(wrapped_env, observation, reward, done, info, action_metadata, prob)
