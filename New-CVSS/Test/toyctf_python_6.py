...
import cyberbattle.agents.baseline.learner_ppo as learnerp
import cyberbattle.agents.baseline.learner_a2c as learnera
...
import cyberbattle.agents.baseline.agent_a2c as a2c
...
tabularq_run = learner.epsilon_greedy_search(
    ...
    render=render,
    title="Q-Learning0015",
    env_str="toyctf",
    save_count = save_count
)
'''
dql2_run = learner.epsilon_greedy_search(
    cyberbattle_gym_env=gym_env,
    environment_properties=ep,
...
dql_run = learner.epsilon_greedy_search(
    ...
    verbosity=Verbosity.Quiet,
    render=render,
    title="DuelingDQN_0.015_alphaCVSS",
    env_str="toyctf",
    save_count = save_count
)
...
tabularq_run = learner.epsilon_greedy_search(
    ...
    verbosity=Verbosity.Quiet,
    render=render,
    title="Q-Learning_0.99_alphaCVSS",
    env_str="toyctf",
    save_count = save_count
)
...
dql_run = learner.epsilon_greedy_search(
    ...
    verbosity=Verbosity.Quiet,
    render=render,
    title="DuelingDQN_0.99_alphaCVSS",
    env_str="toyctf",
    save_count = save_count
)
'''
ppo_run = learnerp.epsilon_greedy_search(
    cyberbattle_gym_env=gym_env,
    environment_properties=ep,
    learner=ppo.PPOLearnerPolicy(
        ep=ep,
        gamma=0.99,
        episodes = episode,
        step = step,
...
a2c_run = learnera.epsilon_greedy_search(
    cyberbattle_gym_env=gym_env,
    environment_properties=ep,
    learner=a2c.A2CLearnerPolicy(
        ep=ep,
        gamma=0.99,
        batch_size=64,
        # torch default learning rate is 1e-2
...
#######################
'''
tabularq1_run = learner.epsilon_greedy_search(
    cyberbattle_gym_env=gym_env,
    environment_properties=ep,
    learner=tqa.QTabularLearner(
        ep=ep,
...
dql1_run = learner.epsilon_greedy_search(
    cyberbattle_gym_env=gym_env,
    environment_properties=ep,
    learner=dqla.DeepQLearnerPolicy(
        ep=ep,
...
ppo1_run = learnerp.epsilon_greedy_search(
    cyberbattle_gym_env=gym_env,
    environment_properties=ep,
    learner=ppo.PPOLearnerPolicy(
        ep=ep,
...
a2c1_run = learnera.epsilon_greedy_search(
    cyberbattle_gym_env=gym_env,
    environment_properties=ep,
    learner=a2c.A2CLearnerPolicy(
        ep=ep,
