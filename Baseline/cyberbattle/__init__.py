...
register(
    ...
    kwargs={'defender_agent': None,
            'attacker_goal': AttackerGoal(own_atleast=8),
            'defender_goal': DefenderGoal(eviction=True),
#            'winning_reward' : 1000.0,
#            'losing_reward' : 0.0
            },
...
if 'CyberBattleSMAI-v0' in registry.env_specs:
    del registry.env_specs['CyberBattleSMAI-v0']

register(
    id='CyberBattleSMAI-v0',
    cyberbattle_env_identifiers=toy_ctf.ENV_IDENTIFIERS,
    entry_point='cyberbattle._env.cyberbattle_smai:CyberBattleSMAI',
    kwargs={'defender_agent': None,
            'attacker_goal': AttackerGoal(own_atleast=8),
            'defender_goal': DefenderGoal(eviction=True),
#            'winning_reward' : 1000.0,
