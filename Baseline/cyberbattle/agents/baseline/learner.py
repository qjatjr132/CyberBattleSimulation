    ...
    while episode<301:
	    ...
	    # exploration episode 설정
            ...
            if reward > 0:
                ...
                print(f"timestep {steps} : gym_action={gym_action}, action_metadata={action_metadata}\n")
        ...
        rate_num = stats['exploit']['reward']['local'] + stats['exploit']['reward']['remote'] + stats['exploit']['reward']['connect'] + stats['exploit']['noreward']['local'] + stats['exploit']['noreward']['remote'] + stats['exploit']['noreward']['connect']
        if rate_num == 0:
            episodes_success_rate_exploit = 0
        else :
            episodes_success_rate_exploit = (stats['exploit']['reward']['local'] + stats['exploit']['reward']['remote'] + stats['exploit']['reward']['connect'])/(stats['exploit']['reward']['local'] + 
                                 stats['exploit']['reward']['remote'] + 
                                 stats['exploit']['reward']['connect'] +
        ...
        learner.end_of_episode(i_episode=episode, t=length)
